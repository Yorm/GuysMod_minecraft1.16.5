...
public class ItemNames {
    ...
    public static final String DON_BUNDLE = "don_bundle";
    ...
    public static final String LEXA_SPAWN_EGG = "lexa_spawn_egg";

    public static final String RECORD_DAYDREAMS = "daydreams_whisper_of_the_streets";
}
